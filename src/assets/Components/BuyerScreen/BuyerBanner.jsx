    ...
    return (
        <div className="lg:mb-32">
            ...
            <div className="max-w-3xl mx-auto bg-white text-black p-8 lg:absolute z-40 left-0 right-0 top-56">
                ...
                <Link to='/result'> <button className="btn btn-accent text-lg font-normal w-full  capitalize border-0 text-white hover:text-black   bg-[#0059B1] "> <svg className="hover:text-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
